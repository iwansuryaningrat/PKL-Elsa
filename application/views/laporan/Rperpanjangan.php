    ...
    <div class="col-xs-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#rekap" data-toggle="tab">Rekap Data Perpanjangan</a></li>
        </ul>
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="detail">
            <div class="box">
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <form method="post" action="<?php echo base_url('index.php/cperpus/Rpanjang'); ?>" target="_blank">
            ...
            <div class="box">
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <form method="post" class="form-horizontal" action="<?php echo base_url('index.php/cperpus/RBpanjang') ?>" target="_blank">
                  ...
                  <div class="col-md-4 col-xs-12">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="tahun" onkeypress="return hanyaangka(event)" placeholder="<?php echo date('Y'); ?>" />
                    </div>
                  </div>
