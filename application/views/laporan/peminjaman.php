    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs success">
        <li class="active"><a href="#rekap" data-toggle="tab">Rekap Data Peminjaman</a></li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="detail">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" action="<?php echo base_url('claporan/peminjamanH'); ?>" target="_blank">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" class="form-horizontal" action="<?php echo base_url('claporan/peminjamanB') ?>" target="_blank">
