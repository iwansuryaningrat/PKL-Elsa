<?php if ($this->session->flashdata('psn')=="dataada") { ?>
<script>
	iziToast.show({
		timeout:6000,
		color:'red',
...
<div class="box box-success">
	...
	<div class="box-body">
		<form method="post" role="form" action="<?php echo base_url('canggota/simpana'); ?>">
	  <div class="form-group">
	      <label>Nama</label>
	      <input type="text" class="form-control" placeholder="Nama Anggota" name="nama" required="" autofocus="">
	  </div>
	  <div class="form-group">
	      <label>Kelas</label>
